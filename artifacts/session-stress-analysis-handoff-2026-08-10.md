...
The current full direct/captured fork corpus in `artifacts/session-gib-stress-source-bound-2026-08-10.json` is bound to product source `aec5bc6d0565a7d1be523fd78da183774794bd73`. Direct fork p50/p95 was 2,854.4/2,947.5 ms at a p95 80.5 MiB RSS increase; captured fork p50/p95 was 2,182.0/2,316.8 ms at a p95 75.8 MiB RSS increase. These results remain below the accepted four-second fork and 8.2-second first-open budgets. The earlier profile and A/B matrices in sections 14.3–14.4 remain explicitly bound to their cited `b41feb2ad` source and are retained as historical causal evidence, not relabeled as current-source runs.
