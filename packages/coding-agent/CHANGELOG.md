...
- Queued-message selection now accepts the actual macOS Terminal.app Option+Up/Down byte sequence, enabling multi-message restore, delete, and reorder flows.
