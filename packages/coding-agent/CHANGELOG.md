...
- Speech-to-text setup now reports platform-correct recorder installation commands and prints the complete enable/record/transcribe flow after a successful check or install. The new operator guide covers the Alt+H toggle, macOS Option/Meta forwarding and microphone permission, model behavior, troubleshooting, and key remapping.
