...
describe("SessionManager cold sidecar integration", () => {
	...
	it("rejects nested managed transcript replacement after capture", async () => {
	...
	it("reopens nested managed cold history and disposes its private sidecar cache", async () => {
